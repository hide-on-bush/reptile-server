...
public class OpencvUtil {
    ...
    public static Mat binary(Mat mat) {
        Mat binary = new Mat();
        threshold(mat, binary, 150, 255, THRESH_BINARY);
    ...
    public static Mat dilate(Mat mat, int size) {
        ...
        Imgproc.dilate(mat, dilate, element, new Point(-1, -1));
        return dilate;
    }
    ...
    public static Mat face(Mat mat) {
        CascadeClassifier faceDetector = new CascadeClassifier(
                "D:\\xsx-tools\\opencv\\opencv\\build\\etc\\haarcascades\\haarcascade_frontalface_alt.xml");
        // 在图片中检测人脸
