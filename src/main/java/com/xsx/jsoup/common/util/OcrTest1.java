...
//    }
    public static void main(String[] args) {
        ...
        URL url = ClassLoader.getSystemResource("lib/opencv/opencv_java460.dll");
        System.load(url.getPath());
        String path = "C:\\Users\\Administrator\\Desktop\\xx4.jpg";
        Mat mat = imread(path);
        imshow("灰度", mat);
        cardUp(mat);
    }
    ...
    public static void cardDown(Mat mat) {
        ...
        Imgcodecs.imwrite("C:\\Users\\Administrator\\Desktop\\result.jpg", mat);
    ...
    public static String temp(Mat mat) {
        ...
        Imgcodecs.imwrite("C:\\Users\\Administrator\\Desktop\\temp.jpg", temp);
    ...
    public static String organization(Mat mat) {
        ...
        Imgcodecs.imwrite("C:\\Users\\Administrator\\Desktop\\organization.jpg", name);
    ...
    public static String time(Mat mat) {
        ...
        Imgcodecs.imwrite("C:\\Users\\Administrator\\Desktop\\time.jpg", time);
        ...
        Imgcodecs.imwrite("C:\\Users\\Administrator\\Desktop\\start.jpg", start);
        ...
        Imgcodecs.imwrite("C:\\Users\\Administrator\\Desktop\\end.jpg", end);
    ...
    public static void cardUp(Mat mat) {
        ...
        Imgcodecs.imwrite("C:\\Users\\Administrator\\Desktop\\houghLinesP.jpg", mat);
        //循环进行人脸识别,校正图片方向
        mat = OpencvUtil.faceLoop(mat);
        Imgcodecs.imwrite("C:\\Users\\Administrator\\Desktop\\face.jpg", mat);
        //灰度
        mat = OpencvUtil.gray(mat);
        //二值化
        mat = OpencvUtil.binary(mat);
        ...
        //膨胀
        mat = OpencvUtil.dilate(mat, 3);
        Imgcodecs.imwrite("C:\\Users\\Administrator\\Desktop\\card-ocr.jpg", mat);
        //获取名称
    ...
    public static String name(Mat mat) {
        ...
        Imgcodecs.imwrite("C:\\Users\\Administrator\\Desktop\\name.jpg", name);
        BufferedImage nameBuffer = OpencvUtil.Mat2BufImg(name, ".jpg");
        String nameStr = OcrUtil.getImageMessage(nameBuffer, "chi_sim");
        nameStr = nameStr.replace("\n", "");
        return nameStr + "\n";
    ...
    public static String sex(Mat mat) {
        ...
        Imgcodecs.imwrite("C:\\Users\\Administrator\\Desktop\\sex.jpg", sex);
    ...
    public static String birthday(Mat mat) {
        ...
        Imgcodecs.imwrite("C:\\Users\\Administrator\\Desktop\\birthday.jpg", birthday);
        //年份
        ...
        Imgcodecs.imwrite("C:\\Users\\Administrator\\Desktop\\year.jpg", year);
        ...
        Imgcodecs.imwrite("C:\\Users\\Administrator\\Desktop\\month.jpg", month);
        ...
        Imgcodecs.imwrite("C:\\Users\\Administrator\\Desktop\\day.jpg", day);
    ...
    public static String address(Mat mat) {
        ...
        Imgcodecs.imwrite("C:\\Users\\Administrator\\Desktop\\address.jpg", address);
    ...
    public static String card(Mat mat) {
        ...
        Imgcodecs.imwrite("C:\\Users\\Administrator\\Desktop\\card.jpg", card);
